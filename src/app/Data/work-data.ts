    ...
    content: [
      {
        ...
        elemList: [
          ...
          "Was the spokesperson for my team when presenting our work to Desjardins partners and to Guy Cormier.",
          "Explored various approaches to fulfill our need for data, including generating our own datasets, searching for public datasets, and exploring available APIs."
        ],
    ...
    content: [
      {
        ...
        elemList : [
          "Created multiple ML models in Python whose purposes were to recommend means and goals to students. The models were then compared with each other using performance metrics.",
          "Communicated with the client to make sure our vision and expectations for the project aligned all the while discussing all our options with the resources available to us.",
    ...
    content: [
      {
        ...
        elemList: [
          ...
          "Développé des logic app, des function app ainsi que des pipelines sur Azure Synapse qui ont permis une entité gouvernementale de migrer et de moderniser son infrastructure backend."
        ],
